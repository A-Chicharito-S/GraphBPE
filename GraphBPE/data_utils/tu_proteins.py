...
def pre_transform_proteins(idx: int, data: Data):
    idx2node = {0: 'P1', 1: 'P2', 2: 'P3'}
    ...
    data.name = 'proteins_' + str(idx + 1)
    return data


class AugmentedProteins(TUDataset):
    def __init__(self, root: str, name: str,
        ...
        super().__init__(root=root, name=name, transform=transform, pre_transform=pre_transform_proteins,
